...
<template>
  <UPageBody prose>
    ...
    <div class="flex flex-col">
      ...
      <p>GitHub Traffic Viewer uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Germany and choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Germany and process it there.
      </p>
      <p>
      ...
      <p>
        GitHub Traffic Viewer will take all steps reasonably necessary to ensure that your data is treated securely and
      ...
      <p>
        GitHub Traffic Viewer may disclose your Personal Data in the good faith belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of GitHub Traffic Viewer</li>
      ...
      <h3>Analytics</h3>
      <p>We monitor and analyze the use of our Service.</p>
      <ul>
        <li>
          <p>
          ...
          <p>
            We use a self-hosted analytics solution with server in Germany to track data like browser, operating system
            and visited pages.
          </p>
        </li>
      </ul>
      ...
      <ul>
        <li>By email: <NuxtLink to="mailto:mail@mokkapps.de" target="_blank" external>mail@mokkapps.de</NuxtLink></li>
      </ul>
    </div>
  </UPageBody>
</template>
