...
const PrivacyPolicyPage = () => (
  <Layout>
    ...
    <p>
      GitHub Traffic Viewer ("us", "we", or "our") operates the
      https://github-traffic-viewer.netlify.com/ website (the "Service").
    </p>

    <p>
      This page informs you of our policies regarding the collection, use, and
      disclosure of personal data when you use our Service and the choices you
      have associated with that data. Our Privacy Policy for GitHub Traffic
      Viewer is managed through{' '}
    ...
    <p>
      ...
      accessible from https://github-traffic-viewer.netlify.com/
    </p>
    ...
    <p>
      GitHub Traffic Viewer will take all steps reasonably necessary to ensure
    ...
    <p>
      GitHub Traffic Viewer may disclose your Personal Data in the good faith
      belief that such action is necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>
        To protect and defend the rights or property of GitHub Traffic Viewer
      </li>
      <li>
    ...
    <h3>Analytics</h3>
    <p>
      We monitor and analyze the use of our Service.
    </p>
    <ul>
      <li>
        <p>
        ...
        <p>
          We use a self-hosted analytics solution with server in Germany to
          track data like browser, operating system and visited pages.
        </p>
      </li>
    </ul>
